...
const data = {
  ...
  'Math/Engineering Softwares': [
    ...
    { skill: 'Pointwise', value: 0.65, logo: 'pointwise.png' },
    { skill: 'placeholder9', value: 0 },
    { skill: 'placeholder10', value: 0 }
  ],
  'Markup Languages': [
    ...
    { skill: 'XML', value: 0.5, logo: 'xml.png' },
  ...
  Design: [
    ...
    { skill: 'Alias', value: 0.4, logo: 'alias.png' },
    { skill: 'placeholder7', value: 0 },
    { skill: 'placeholder8', value: 0 },
    { skill: 'placeholder9', value: 0 },
    { skill: 'placeholder10', value: 0 }
