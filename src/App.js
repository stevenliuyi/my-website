  ...
  render() {
    return (
      <div>
        ...
        <ScrollOverPack ref={el => this.aboutPage = el} id="about-page" className="about-page" playScale={0.6} always={false}>
          <QueueAnim type="left" key='0' duration={1000} interval={200} delay={500}>
            <div key='0' className="section-title">ABOUT</div>
            <div key='1' className="underline" />
          </QueueAnim>
          <TweenOne key='1' style={{ opacity: 0, transform: 'rotateY(90deg)'}} animation={{ opacity: 1, rotateY: 0 ,  duration:1000, ease: 'easeInQuart', delay: 500 }}>
            <img className="logo" src="/icons/android-chrome-192x192.png" height={100} width={100} alt="logo" />
          </TweenOne>
          <QueueAnim animConfig={{opacity:[1,0], translateX: [0, -100]}} key='2' className="about-text" duration={1000} interval={200} delay={1500}>
        ...
        <ScrollOverPack id="project-page" className="project-page" playScale={0.6} always={false}>
          <QueueAnim type="left" key='0' duration={1000} interval={200} delay={500} leaveReverse={true}>
            <div key='0' className="section-title">PROJECTS</div>
            <div key='1' className="underline" />
          </QueueAnim>
          <QueueAnim type="bottom" key='1' className="projects" duration={2000} interval={0} delay={1500}
           onEnd={({ key, type }) => {
        ...
        <ScrollOverPack id="contact-page" className="contact-page" playScale={0.1} always={false}>
          <QueueAnim type="left" key='0' duration={1000} delay={500} interval={200}>
