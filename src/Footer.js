  ...
  render() {
    return (
      <ScrollOverPack id="contact-page" className="contact-page" playScale={0.1} always={false}>
        ...
        <TweenOne key='2' className="contact-email" animation={{ opacity: 1, translateY: 0, delay: this.props.delay + 500, duration: 1000}}><a href="mailto:me@yliu.io">me<span className="at">@</span>yliu.io</a></TweenOne>
      </ScrollOverPack>
    );
  }
}
